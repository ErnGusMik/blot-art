...
t.forward(getChord(tvHeight, tvScreenDeg) / 15).up().forward(4).down()
t.forward(getChord(tvHeight, tvScreenDeg) / 15).up().forward(3).down()
...
t.right(120).forward(getChord(tvWidth, tvScreenDeg) / 6 + 20)
t.right(60).forward(getChord(tvWidth, tvScreenDeg) / 6)
