...
const tvWidth = bt.randInRange(200, 320) // default: 230
...
// Scene
t.right(10).forward(getChord(tvWidth, tvScreenDeg)/2)
t.left(170).up()
...
// //   t.arc(20, 30).right(90).forward(10).left(180).forward(10).right(90)
// //   t.arc(20, 30).right(90).forward(10).left(180).forward(10).right(90)
// //   text = DrawText('Wakey wakey\neggs and bacey', [0, 0], 2)
// // } else if (hours < 2) {
  
// // } else if (hours < 3) {
// //   text = DrawText('Breaking news', [70, 100], 1)
// // } else {
// //   text = DrawText('Off. It\'s late', [0, 0], 2)
// // }
// // const all = [...t.lines(), ...text]
